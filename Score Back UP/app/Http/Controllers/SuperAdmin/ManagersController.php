...
class ManagersController extends Controller
{
	...
	public function add_manager()
	{
		...
		return view('super_admin.add_manager', $data);
	}
	...
	public function add_new_manager(Request $request)
	{
		...
		return redirect('admin_panel/managers_list')->with('success', ling('added_succ'));	
	}
	...
	public function managers_list(Request $request = NULL)
	{
		...
		$data['managers'] = DB::table('users')
							->select('users.name', 'users.email', 'users.seen', 'users.id as user_id', 'user_roles.role_id', 'countries.name as country_name', 'states.name as region', 'organizations.org_name')
		...
		return view('super_admin.managers_list', $data);
	}
	...
	public function edit_manager($id)
	{
		...
		return view('super_admin.edit_manager', $data);
	}
