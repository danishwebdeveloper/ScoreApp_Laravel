...
@section('page_title', 'Talent Ranker - '.ling('add_new_admin'))


@section('content')

	<div class="m-heading-1 border-green m-bordered">
		<h5 style="display: inline-block">Talent Ranker - {{ ling('add_new_admin') }}!</h5>
        ...
        <div class="col-md-8">
            <div class="portlet light ">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form action="{{ url('admin_panel/add_new_admin') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                      {{ csrf_field() }}
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label">{{ ling('sel_birth_year') }}</label>
                                <div class="col-md-6">
            ...
            <div class="portlet light ">
                ...
                <div class="portlet-body form">
                    <div class="form-body">
                      ...
                      <div class="form-group">
                          <label class="control-label">{{ ling('c_password') }}</label>
