      ...
      <div class="portlet light ">
          <div class="portlet-title">
              ...
              <div class="pull-right col-md-9">
                <form method="GET" action="{{ url('admin_panel/players_list') }}">
                    ...
                    <a href="{{ url('admin_panel/players_list') }}" class="btn btn-circle green-meadow pull-right"><i class="fa fa-refresh"></i> {{ ling('reset') }}</a>
                </form>
              </div>
          </div>
