...
@section('content')
	...
	<div class="m-heading-1 border-green m-bordered">
		...
		<a href="{{ url('admin_panel/add_team') }}" class="btn btn-circle green-meadow pull-right"><i class="fa fa-plus"></i> {{ ling('add_team') }}</a>
	</div>
            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    ...
                    <div class="pull-right col-md-8">
                      <form method="GET" action="{{ url('admin_panel/teams') }}">
                          ...
                          <a href="{{ url('admin_panel/teams') }}" class="btn btn-circle green-meadow pull-right"><i class="fa fa-refresh"></i> {{ ling('reset') }}</a>
                      </form>
                    </div>
                </div>
