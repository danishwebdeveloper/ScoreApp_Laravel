...
@section('content')
	...
	<div class="m-heading-1 border-green m-bordered">
		...
		<a href="{{ url('admin/add_manager') }}" class="btn btn-circle green-meadow pull-right"><i class="fa fa-plus"></i> {{ ling('add_new_manager') }}</a>
	</div>
  @php 
            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    ...
                    <div class="pull-right col-md-8">
                      <form method="GET" action="{{ url('admin/managers_list') }}">
                          ...
                          <a href="{{ url('admin/managers_list') }}" class="btn btn-circle green-meadow pull-right"><i class="fa fa-refresh"></i> {{ ling('reset') }}</a>
                      </form>
                    </div>
                </div>
                    <table class="table table-hover" id="sample_1">
                        ...
                        <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <a href="{{ url('admin/edit_manager/'.$manager->user_id) }}" class="btn btn-xs green">
                                 {{ ling('edit') }} <i class="fa fa-edit"></i></a>
                                 <a href="javascript:void(0);" onclick="confirmDelete('{{ url('admin/delete_manager/'.$manager->user_id) }}')" class="btn btn-xs red">
