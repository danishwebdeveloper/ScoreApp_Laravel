...
@section('content')
	...
	<div class="m-heading-1 border-green m-bordered">
		...
		<a href="{{ url('admin/players') }}" class="btn btn-circle green-meadow pull-right"><i class="fa fa-reply"></i> {{ ling('go_back') }}</a>
	</div>
  @php 
        ...
        <div class="col-md-8">
            <div class="portlet light ">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form action="{{ url('admin/update_player') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                      {{ csrf_field() }}
                        <div class="form-body">
