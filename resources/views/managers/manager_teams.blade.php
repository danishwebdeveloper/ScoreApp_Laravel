...
@section('page_title', 'Talent Ranker - '.ling('manager').' '.ling('teams'))


@section('content')

	<div class="m-heading-1 border-green m-bordered">
		<h5 style="display: inline-block">Talent Ranker - {{ ling('manager').' '.ling('teams') }}!</h5>
            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    ...
                    <div class="pull-right col-md-6">
                      <form method="GET" action="{{ url('manager/teams') }}">
                          ...
                          <a href="{{ url('manager/teams') }}" class="btn btn-circle green-meadow pull-right"><i class="fa fa-refresh"></i> Reset</a>
                      </form>
                    </div>
                </div>
                    <table class="table table-hover" id="sample_1">
                        ...
                        <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <a href="{{ url('manager/edit_team/'.$team->id) }}" class="btn btn-xs green">
                                 {{ ling('edit') }} <i class="fa fa-edit"></i></a>
                                 <a href="javascript:void(0);" onclick="confirmDelete('{{ url('manager/delete_team/'.$team->id) }}')" class="btn btn-xs red">
