...
@section('content')
	...
	<div class="m-heading-1 border-green m-bordered">
		...
		<a href="{{ url('manager/add_player') }}" class="btn btn-circle green-meadow pull-right"><i class="fa fa-plus"></i> {{ ling('add_new_player') }}</a>
	</div>
  @php 
      ...
      <div class="portlet light ">
          <div class="portlet-title">
              ...
              <div class="pull-right col-md-9">
                <form method="GET" action="{{ url('manager/players') }}">
                    ...
                    <a href="{{ url('manager/players') }}" class="btn btn-circle green-meadow pull-right"><i class="fa fa-refresh"></i> {{ ling('reset') }}</a>
                </form>
              </div>
          </div>
              <table class="table table-hover" id="sample_1">
                  ...
                  <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="{{ url('manager/edit_player/'.$player->user_id) }}" class="btn btn-xs green">
                           {{ ling('edit') }} <i class="fa fa-edit"></i></a>
                           <a href="javascript:void(0);" onclick="confirmDelete('{{ url('manager/delete_player/'.$player->user_id) }}')" class="btn btn-xs red">
